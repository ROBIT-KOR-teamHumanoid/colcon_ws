#ifndef ROBOCUP_MASTER25_NODE_HPP
#define ROBOCUP_MASTER25_NODE_HPP
...
class RobocupMaster25Node : public rclcpp_lifecycle::LifecycleNode {
 public:
  RobocupMaster25Node(
 ...
 private:
  std::shared_ptr<robocup_master25::Player> player;
  rclcpp::TimerBase::SharedPtr timer;

  rclcpp::Subscription<humanoid_interfaces::msg::ImuMsg>::SharedPtr imu_sub;
  rclcpp::Subscription<humanoid_interfaces::msg::Robocupvision25>::SharedPtr
      vision_sub;
  rclcpp::Subscription<humanoid_interfaces::msg::IkEndMsg>::SharedPtr ik_sub;
  rclcpp::Subscription<humanoid_interfaces::msg::Gamecontroldata>::SharedPtr
      gamecontrol_sub;
  rclcpp::Subscription<
      humanoid_interfaces::msg::Robocuplocalization25>::SharedPtr local_sub;
  ...
  rclcpp_lifecycle::LifecyclePublisher<
      humanoid_interfaces::msg::Master2IkMsg>::SharedPtr ik_pub;
  rclcpp_lifecycle::LifecyclePublisher<
      humanoid_interfaces::msg::Master2vision25>::SharedPtr vision_pub;
  rclcpp_lifecycle::LifecyclePublisher<
      humanoid_interfaces::msg::Gamecontrolreturndata>::SharedPtr
      gamecontrol_pub;
  rclcpp_lifecycle::LifecyclePublisher<
      humanoid_interfaces::msg::Master2localization25>::SharedPtr local_pub;
  rclcpp_lifecycle::LifecyclePublisher<
      humanoid_interfaces::msg::Master2udp>::SharedPtr udp_pub;
  rclcpp_lifecycle::LifecyclePublisher<
      humanoid_interfaces::msg::MotionOperator>::SharedPtr motionPub;
...
#endif  // ROBOCUP_MASTER25_NODE_HPP
